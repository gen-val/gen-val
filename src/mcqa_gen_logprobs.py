"""
    Multiple choice question answer-based generator evaluation under logprobs setting
"""
...
def gen_logprobs(args):
    ...
    for fn in os.listdir(dir_data):
        if fn.endswith("_mcqa.json") and args[fn.split('_')[0].lower()]:
            ...
            fn_out = os.path.join(args["dir_res"], f"{fn.split('_')[0]}_{args['st_task']}_{args['st_mdl']}.json") # output file name
